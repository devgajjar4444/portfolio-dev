...
export const personal = {
  ...
  bio: "Full Stack Software Engineer with 3.5+ years of experience delivering end-to-end solutions across web, mobile, and backend systems. I specialize in Node.js, NestJS, Next.js, React, React Native, and Go — with a strong focus on security, scalability, performance, and clean architecture.",
  about:
    "I build production-grade products end to end — from architecture and APIs to polished web and mobile experiences. As an AI lead engineer, I integrate LLMs, AI assistants, and third-party AI services into real workflows (training pipelines, inference APIs, and product features). I'm equally comfortable on client calls, gathering requirements, and leading small teams — coordinating delivery, unblocking developers, and keeping stakeholders aligned.",
...
export const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: ["LLM Integration", "AI Assistants", "Custom Model Training", "OpenAI APIs", "AI Workflows"],
  },
  {
...
export const projects: Project[] = [
  ...
  },
  {
    id: "sevenly",
    name: "Sevenly",
    tagline: "Travel platform redesign — hotels, deals & modern booking experience",
    description:
      "Sevenly is a live travel platform where I am redesigning the application and implementing new functionalities. The work focuses on delivering a modern, futuristic user experience while maintaining stability of the production system with optimized third-party API integrations.",
    responsibilities: [
    ...
    url: "https://dev.sevenlytech.com/",
    platformUrls: [
      { label: "Legacy Site", url: "https://www.sevenlytravel.com/" },
    ],
    current: true,
    featured: true,
  },
